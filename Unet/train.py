...
from unet_training import (CE, Focal_Loss, dice_loss_with_CE,
...
from Unet_utils.utils1 import show_config
from utils.utils_fit import fit_one_epoch
from Unet_utils.utils_metrics import Iou_score, f_score
...
if __name__ == "__main__":    
    ...
    with open(os.path.join(VOCdevkit_path, "Bladder_Tumor_Datasets/ImageSets/Segmentation/train.txt"),"r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "Bladder_Tumor_DatasetsImageSets/Segmentation/val.txt"),"r") as f:

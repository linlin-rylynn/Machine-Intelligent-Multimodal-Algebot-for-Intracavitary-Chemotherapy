...
from CSPdarknet import (C3, DarknetConv2D, DarknetConv2D_BN_SiLU,
                             darknet_body)
from yolo_training import yolo_loss


#---------------------------------------------------#
# Panet network construction and get prediction results
#---------------------------------------------------#
def yolo_body(input_shape, anchors_mask, num_classes, phi, weight_decay=5e-4):
    ...
    #---------------------------------------------------#   
    # Generate the backbone model and obtain three valid feature layers, their shapes are:
    # 80, 80, 256
    # 40, 40, 512
    # 20, 20, 1024
    #---------------------------------------------------#

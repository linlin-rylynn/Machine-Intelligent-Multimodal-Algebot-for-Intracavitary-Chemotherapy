...
class EvalCallback(keras.callbacks.Callback):
    def __init__(self, model_body, input_shape, anchors, anchors_mask, class_names, num_classes, val_lines, log_dir,\
        ...
        # Post-processing includes decoding, non-maximum suppression, threshold filtering, etc
        #---------------------------------------------------------#
    ...
    def get_map_txt(self, image_id, image, class_names, map_out_path):
        ...
        #---------------------------------------------------------#
        # Convert the image to RGB to prevent errors when predicting with grayscale images
        #---------------------------------------------------------#
        ...
        #---------------------------------------------------------#
        # Add batch_size dimension and normalize the image
        #---------------------------------------------------------#
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if temp_epoch % self.period == 0 and self.eval_flag:
            ...
            for annotation_line in tqdm(self.val_lines):
                ...
                #------------------------------#
                # Get the predicted txt
                #------------------------------#
                self.get_map_txt(image_id, image, self.class_names, self.map_out_path)
                
                #------------------------------#
                # Get the ground truth boxes' txt
                #------------------------------#
